...
gcloud alpha services api-keys create --display-name="cloudcupcake"

KEY_NAME=$(gcloud alpha services api-keys list --format="value(name)" --filter "displayName=cloudcupcake")
...
curl -LO https://raw.githubusercontent.com/Techcps/Google-Cloud-Skills-Boost/master/Extract%20Analyze%20and%20Translate%20Text%20from%20Images%20with%20the%20Cloud%20ML%20APIs/sign.jpg
...
tee nl-request.json <<EOF_CP
{
  "document":{
    "type":"PLAIN_TEXT",
    "content":"like share & subscribe to cloudcupcake"
  },
  "encodingType":"UTF8"
}
EOF_CP
